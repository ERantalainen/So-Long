...
/*   Updated: 2025/06/02 16:41:45 by erantala         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			check_path(char **mp, int sp, t_point *size, char *line);
...
void		ft_init_textures(size_t n, char **map, mlx_t *mlx);
void		ft_init_images( size_t n, char **map, t_txt *txt, mlx_t *mlx);

void		ft_display_images(size_t n, char **map, t_images *img, mlx_t *mlx);
