...
/*   Updated: 2025/06/02 16:12:04 by erantala         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ft_init_textures(size_t n, mlx_t *mlx);
void		ft_init_images( size_t n, t_txt *txt, mlx_t *mlx);
void		ft_display_images(size_t n, t_images *img, mlx_t *mlx);
void		ft_background(mlx_t *mlx, size_t n, t_images *images);
...
void		ft_set_char_rot(int rot);
void		ft_char_cords(void);
